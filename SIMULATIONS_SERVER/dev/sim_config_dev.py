...
sim_root = '/home/danielk/IRF/E3D_PA/SORTSpp_sim/sim_dev'
...
e3d_scan = rslib.ns_fence_rng_model(min_el = 30, angle_step = 1, dwell_time = 0.1)
...
pop._objs = pop._objs[:10,:]

sim = s.simulation( \
	radar = e3d,\
	population = pop,\
	sim_root = sim_root,\
	simulation_name = s.auto_sim_name('NS_FENCE_DEV_MAINT')
	)
