...
sim_root = '/home/danielk/IRF/E3D_PA/SORTSpp_sim/sim_dev_sched_3_crash'
...
#pop = p.master_catalog_factor(treshhold=1e-1,seed=12345)
#pop.filter('i',lambda x: x >= 45.0)
pop._objs = pop._objs[16805,:]
pop._objs.shape = (1,len(pop._objs))
...
sim.calc_observation_params(duty_cycle=0.25, SST_fraction=1.0, tracking_fraction=1.0, interleaving_time_slice = 0.4, SST_time_slice=0.2)
