...
sim_root = '/ZFS_DATA/SORTSpp/rng_full_sst_cold_start'
...
e3d_scan = rslib.sph_rng_model(min_el = 30.0, dwell_time = 0.2)
...
sim = s.simulation( \
    ...
    population = pop,\
    sim_root = sim_root,\
    simulation_name = s.auto_sim_name('rng_full_sst_cold_start')
    )
