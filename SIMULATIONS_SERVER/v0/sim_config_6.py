...
sim_root = '/ZFS_DATA/SORTSpp/sim_ns_fence_master_factor'
...
e3d_scan = rslib.ns_fence_model(min_el = 30, angle_step = 1, dwell_time = 0.1)
...
sim = s.simulation( \
        ...
        simulation_name = s.auto_sim_name('NS_FENCE_FACTOR')
        )
