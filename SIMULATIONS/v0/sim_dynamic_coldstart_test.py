...
sim_root = '/home/danielk/IRF/E3D_PA/SORTSpp_sim/dyn_coldstart_test'
...
pop._objs = pop._objs[:3000,:]

sim = s.simulation( \
    radar = e3d,\
    population = pop,\
    sim_root = sim_root,\
    simulation_name = s.auto_sim_name('dyn_coldstart_test')
    )

sim.calc_observation_params(duty_cycle=0.25, SST_fraction=1.0, tracking_fraction=0.2, SST_time_slice=0.2)
